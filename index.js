 ...
 * @Last Modified time: 2018-12-15 23:35:05
 */
...
module.exports = function({ 
    ...
    svg2font({ src, dist, fontName }, (unicodes) => {
        ...
        fs.writeFileSync(path.join(dist, `${fontName}.wxss`), wxss, { encoding: 'utf8' });
        fs.writeFileSync(path.join(dist, `${fontName}.wxml`), wxml, { encoding: 'utf8' });
    });
};